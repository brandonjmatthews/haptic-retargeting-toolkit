...
Shader "HRTK/LeapMotion/Passthrough Background Manual" {
	...
	SubShader{
	  ...
	  float4 frag(frag_in i) : COLOR {
		...
		return float4(_ManualEye == 0 ? LeapGetLeftColor(i.screenPos) : LeapGetRightColor(i.screenPos), 1);
	  }
